...
class Me(object):
    ...
    def __setstate__(instance,get_instance_dictcopy):
        ...
        instance.__dict__.update(get_instance_dictcopy)
...
if __name__ =="__main__":
    ...
    with open('Me.pickle','rb') as reader:
        ...
        #print getdata # return the class object
        #print getdata.__dict__ # Returns the class dictionary 
